...
class HotkeyCategoryViewModel {
    var hotkeyCategories: [HotkeyCategoryModel] = []
    ...
    init() {
        ...
        let schemeCategory: HotkeyCategoryModel = .init(name: "Scheme", hotkeyModels: [
            ...
            .init(modifiers: [.command],character: "<",text: "Edit scheme"),
        ])
        let hideOrShowPanelsCategory: HotkeyCategoryModel = .init(name: "Hide or Show Panels", hotkeyModels: [
            .init(modifiers: [.command],character: "0",text: "Show/Hide Navigator (Left panel)"),
            .init(modifiers: [.option, .shift],character: "0",text: "Show/Hide Utilities (Right panel)"),
            .init(modifiers: [.shift],character: "Y",text: "Show/Hide the Debug area"),
            .init(modifiers: [.command,.option],character: "⏎",text: "Show/Hide Canvas"),
        ])
        let navigationCategory: HotkeyCategoryModel = .init(
            ...
            hotkeyModels: [
                ...
                .init(modifiers: [.command],character: "3",text: "bookmarks"),
                .init(modifiers: [.command],character: "4",text: "find"),
                .init(modifiers: [.command],character: "5",text: "Issues"),
                .init(modifiers: [.command],character: "6",text: "Tests"),
                .init(modifiers: [.command],character: "7",text: "Debug"),
                .init(modifiers: [.command],character: "8",text: "Breakpoints"),
                .init(modifiers: [.command],character: "9",text: "Reports"),
            ]
        )
